<?php /*a:3:{s:77:"C:\phpStudy\PHPTutorial\WWW\03kj\shop\application\admin\view\goodsp\list.html";i:1563543936;s:72:"C:\phpStudy\PHPTutorial\WWW\03kj\shop\application\admin\view\header.html";i:1563757466;s:72:"C:\phpStudy\PHPTutorial\WWW\03kj\shop\application\admin\view\footer.html";i:1562661169;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<script type="text/javascript">
	function getcate() {
		var goods_id=$("#goods_id").val()
              	   ...
              	   $.ajax({
              	   	url:"<?php echo url('goodsp/getcate'); ?>",
              	   	type:'post',
              	   	data:{
              	   		goods_id:goods_id
              	   	},
              ...
              $.ajax({
				url:"<?php echo url('goodsp/addAction'); ?>",
				type:'post',
				data:{
				price:price,
                   	 ...
                   	 success:function (res) {
                   	 	...
                   	 	data=res.data
                   	 	 ...
                   	 	 for (var i = 0; i < data.length; i++) {
                   	 	   tr=tr+"<tr class='text-c'><td><input type='checkbox' class='mycheckbox' value='"+data[i]['id']+"'></td><td>"+data[i]['id']+"</td><td>"+data[i]['name']+"</td><td>"+data[i]['price']+"</td><td>"+data[i]['n_number']+"</td><td class='f-14 product-brand-manage'><a onclick='modaldemo1()'  style='text-decoration:none' title='编辑'><i class='Hui-iconfont'>&#xe6df;</i></a> <a onclick='del(\""+data[i]['id']+"\",)' style='text-decoration:none' class='delete_one ml-5' title='删除'><i class='Hui-iconfont'>&#xe6e2;</i></a></td></tr>"	
                   	 	 }
                   	 	 $('.table tbody').html(tr)
                   	 }
                   })
              ...
              function del(id) {
                 $.ajax({
                 	url:"<?php echo url('goodsp/delete'); ?>",
                 	type:'post',
                 	data:{
                 		id:id
                 	},
