<?php /*a:3:{s:77:"C:\phpStudy\PHPTutorial\WWW\03kj\shop\application\admin\view\product\add.html";i:1563528850;s:72:"C:\phpStudy\PHPTutorial\WWW\03kj\shop\application\admin\view\header.html";i:1563505848;s:72:"C:\phpStudy\PHPTutorial\WWW\03kj\shop\application\admin\view\footer.html";i:1562661169;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<article class="cl pd-20">
	<form action="" method="post" class="form form-horizontal" id="form-admin-role-add">
		<div class="row cl">
			...
			<select name="goods_ida" id="goods_ida">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">货品属性</label>
			<div class="formControls col-xs-8 col-sm-9">
				
				<dl class="goodsattr-list" id='goodattr-list'>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="sn_number" name="">
			</div>
		</div>
		<div class="row cl">
...
<script>
	function getCate(str,id=0){
		$.ajax({
			url:'<?php echo url("product/showcate"); ?>',
			type:'post',
			dataType:'json',
			success:function(res){
				var option=''
	...
	$('#add').click(function(){
		...
		var goods_id=$('#name').val()
		var price=$('#price').val()
		var sn_number=$('#sn_number').val()
		var mycheckbox=$('.mycheckbox:checked')
		var goods_attr_id=''
		for (var i = 0; i<mycheckbox.length; i++) {
			goods_attr_id=goods_attr_id+','+mycheckbox[i].value
		}
		$.ajax({
	...
	$.ajax({
		url:"<?php echo url("product/showl"); ?>",
	    success:function (res) {
	    	var data=res.data
	    	// console.log(res)
	    	dl=''
	    	$.each(data,function(key,value){
	    		dl=dl+"<dt><label class='' style='color:blue'><input type='checkbox' value=''>"+key+"</label></dt><dd><dl class='cl goodsattr-list2'>"
