<?php /*a:1:{s:77:"C:\phpStudy\PHPTutorial\WWW\03kj\shop\application\admin\view\login\login.html";i:1561633904;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<script src="/static/hui/lib/jquery/1.9.1/jquery.min.js"></script>
<!--[if IE 6]>
		...
		<form class="form form-horizontal" >
			...
			<div class="row cl">
				<div class="formControls col-xs-8 col-xs-offset-3">
					...
					<img src="<?php echo captcha_src(); ?>" alt="captcha" style="width: 200px;height: 50px" id="captcha"  />
					<!-- <img src="<?php echo url('login/verify'); ?>" onclick="changeCode()" style="width: 200px;height: 50px" id="captcha" /> -->
...
<!-- <script type="text/javascript" src="__STSTIC__hui/lib/jquery/1.9.1/jquery.min.js"></script> -->
<!-- <script type="text/javascript" src="__STSTIC__hui/static/h-ui/js/H-ui.js"></script> -->

<script >
	// function changeCode(){
		
		// alert(12)
			// $("#captcha").src="<?php echo url('login/verify'); ?>?"+Math.random()
	// }
	$(document).ready(function(){
		...
		$("#login").click(function(){
			...
			// code_preg=/^\w{5}$/
			// if (!code_preg test(code)) {
			// 	$('#span_captcha').html("验证码格式错误")
			// 	return false;
			// }
			$.ajax({
