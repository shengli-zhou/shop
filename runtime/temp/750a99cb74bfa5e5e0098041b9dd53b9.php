<?php /*a:3:{s:76:"C:\phpStudy\PHPTutorial\WWW\03kj\shop\application\admin\view\goods\list.html";i:1563544260;s:72:"C:\phpStudy\PHPTutorial\WWW\03kj\shop\application\admin\view\header.html";i:1563757466;s:72:"C:\phpStudy\PHPTutorial\WWW\03kj\shop\application\admin\view\footer.html";i:1562661169;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="text-c">
					...
					<!-- <input type="file" id="p_img" multiple="multiple">
					<select name="" id="b_id">
						<option value="">分类</option>
					</select>
					<input type="text" placeholder="产品名称" value="" class="input-text" style="width:120px" id="name">
					<input type="text" placeholder="产品描述" value="" class="input-text" style="width:120px" id="description"> -->
			...
			<span onclick="modaldemo()" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> <a href="<?php echo url('attrcategory/list'); ?>"> 商品属性分类</a> </span>
...
<script>
	...
	function modaldemo(id,goodscate_id,brand_id,name,description,price,online_status){
			...
			success:function(res){
				...
				// }else{
					...
					for (var i = 0; i <data.length; i++){
						tr=tr+"<tr><td><input class='mycheckbox' type='checkbox' value='"+data[i]['id']+"'</td><td><a href='<?php echo url("goodsattr/list"); ?>?id="+data[i]['id']+"'>"+data[i]['id']+"</a></td><td><a href='<?php echo url("goodsimg/list"); ?>?id="+data[i]['id']+"'>查看图片</a></td><td>"+data[i]['g_c_name']+"</td><td>"+data[i]['brand_name']+"</td><td>"+data[i]['name']+"</td><td><a href='<?php echo url("goodsp/list"); ?>?id="+data[i]['id']+"'>"+data[i]['description']+"<i class='Hui-iconfont'>&#xe604;</i></td><td>"+data[i]['price']+"</td><td>"+data[i]['online_status']+"</td><td class='f-14 goods-goods-manage'><a style='text-decoration:none' onclick='modaldemo(\""+data[i]['id']+"\",\""+data[i]['img']+"\",\""+data[i]['g_c_name']+"\",\""+data[i]['brand_name']+"\",\""+data[i]['name']+"\",\""+data[i]['description']+"\",\""+data[i]['price']+"\",\""+data[i]['online_status']+"\")' title='编辑'><i class='Hui-iconfont'>&#xe6df;</i></a> <a style='text-decoration:none' class= ml-5' onclick='del("+data[i]['goods_id']+")' title='删除'><i class='Hui-iconfont'>&#xe6e2;</i></a></td></tr>";			
					}
					$('.table tbody').html(tr)
