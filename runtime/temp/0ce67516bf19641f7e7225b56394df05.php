<?php /*a:3:{s:79:"C:\phpStudy\PHPTutorial\WWW\03kj\shop\application\admin\view\goodsimg\list.html";i:1563355167;s:72:"C:\phpStudy\PHPTutorial\WWW\03kj\shop\application\admin\view\header.html";i:1563757466;s:72:"C:\phpStudy\PHPTutorial\WWW\03kj\shop\application\admin\view\footer.html";i:1562661169;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		$.ajax({
		  		...
		  		success:function(res) {
		  			...
		  			for (var i = 0; i < arr.length; i++) {
						...
						tr=tr+"<tr class='text-c'><td><input  type='checkbox' value='"+arr[i].id+"'></td><td>"+arr[i].id+"</td><td><img src='/uploads/goodsimg/"+arr[i].big_img+"' ></td><td><img src='/uploads/goodsimg/"+arr[i].middle_img+"' ></td><td><img src='/uploads/goodsimg/"+arr[i].small_img+"' ></td><td class='f-14 product-brand-manage'><a style='text-decoration:none' class='ml-5' title='删除' onclick='dele("+arr[i].id+")'><i class='Hui-iconfont'>&#xe6e2;</i></a></td></tr>"
					}
					$("#ii").html(tr);
		  		}
