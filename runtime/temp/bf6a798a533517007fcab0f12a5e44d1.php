<?php /*a:3:{s:82:"C:\phpStudy\PHPTutorial\WWW\03kj\shop\application\admin\view\attrdetails\list.html";i:1563413165;s:72:"C:\phpStudy\PHPTutorial\WWW\03kj\shop\application\admin\view\header.html";i:1563505848;s:72:"C:\phpStudy\PHPTutorial\WWW\03kj\shop\application\admin\view\footer.html";i:1562661169;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<section class="Hui-article-box">
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 产品管理 <span class="c-gray en">&gt;</span> 产品属性细分 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
		
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="text-c">
					<input  hidden="" id="__token__" name="__token__" value="<?php echo htmlentities(app('request')->token()); ?>">
					<input  type="text" hidden="" name="" value="<?php echo htmlentities($attr_id); ?>" id="attr_id">
					<input type="text" placeholder="产品属性细分" value="" class="input-text" style="width:120px" id="name">
