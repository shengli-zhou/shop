...
class Goodsp extends Common
{
          ...
          public function list()
          {
            ...
            public function getcate()
            {
             ...
             $arr=Db::query("select attribute.id as a_id,attribute.name as a_name,goodsattr.attr_id as ga_attr_id,goodsattr.attr_details_id as ga_ad_id,attrdetails.name as ad_name,attrdetails.id as a_d_id from attribute join goodsattr on attribute.id=goodsattr.attr_id join attrdetails on goodsattr.attr_details_id=attrdetails.id where goodsattr.goods_id='$goods_id'");
             $newarr=[];
              ...
              $goods_id=$data['goods_id'];
                ...
                for ($i=0; $i <count($arr) ; $i++) { 
                  ...
                  for ($j=0; $j <count($all_goods_attr_id) ; $j++) { 
                     ...
                     //字符串
                     $arr1=Db::query("select * from attrdetails where id='$goods_attr_id'");
                     //查询属性细分的名称
